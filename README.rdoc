...
== IMPORTANT RELEASE NOTES ==
 This version of the Gatoroid GEM is a beta release to support Rails 4 in conjunction with the mongoid V4.beta1. I am trying my best to keep up with the latest versions.
	This gem has been tested using:
	Mongoid::VERSION:4.0.0.beta1
	Moped::VERSION:2.0.0.beta6
	MongoDB Version 2.2
